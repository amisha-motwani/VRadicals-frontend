...
import AddEmployees from "./views/Add/AddEmployees";
import EmployeeStatus from "./views/Status/EmployeeStatus";
...
const routes = [
  ...
  { path: "/AddEmployees", name: "Add Employees", element: AddEmployees },
  { path: "/EmployeeStatus", name: "Employee Status", element:EmployeeStatus },
];
